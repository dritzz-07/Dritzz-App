  ...
  return (
    <div className="px-4 pt-6 pb-24 animate-in fade-in duration-500">
      <div className="flex items-center gap-4 mb-8">
        <div className="w-16 h-16 rounded-full bg-gradient-to-tr from-zinc-500 to-zinc-300 p-[2px]">
      ...
      <div className="grid grid-cols-2 gap-3 mb-8">
        <div className="bg-neutral-900 p-4 rounded-2xl border border-neutral-800">
          <Car size={20} className="text-zinc-400 mb-2" />
          <div className="text-xl font-bold text-white">2</div>
          <div className="text-xs text-neutral-400">Saved Vehicles</div>
        </div>
        <div className="bg-neutral-900 p-4 rounded-2xl border border-neutral-800">
          <CreditCard size={20} className="text-zinc-400 mb-2" />
