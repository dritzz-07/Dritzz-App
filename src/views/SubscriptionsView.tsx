  ...
  return (
    <div className="px-4 pt-6 pb-24 animate-in fade-in duration-500">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-neutral-900 rounded-3xl p-5 border border-neutral-800">
          ...
          <ul className="space-y-3 mb-6">
            <li className="flex items-center gap-3 text-sm text-neutral-300">
              <div className="bg-zinc-400/20 p-1 rounded-full"><Check size={14} className="text-zinc-400" /></div>
        ...
        {/* Premium Plan */}
        <div className="bg-gradient-to-br from-zinc-900/40 to-black rounded-3xl p-5 border border-zinc-400/30 relative">
          <div className="absolute -top-3 left-1/2 -translate-x-1/2 flex items-center gap-1 bg-zinc-500 text-white px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wide">
            <Star size={12} /> Most Popular
          </div>
          <div className="flex justify-between items-start mb-4 mt-2">
            <div>
              <h3 className="text-lg font-semibold text-white">Premium Care</h3>
              <p className="text-sm text-zinc-200/80">Complete protective care.</p>
            </div>
            <div className="text-right">
              <span className="text-2xl font-display font-bold text-white">₹1,999</span>
              <span className="text-xs text-zinc-200/80 block">/month</span>
            </div>
          </div>
          
          <ul className="space-y-3 mb-6">
            <li className="flex items-center gap-3 text-sm text-zinc-100">
              <div className="bg-zinc-400 p-1 rounded-full"><Check size={14} className="text-white" /></div>
          ...
          <motion.button 
            whileTap={{ scale: 0.98 }}
            className="w-full py-3 rounded-xl bg-zinc-500 shadow-[0_0_20px_rgba(37,99,235,0.3)] text-white font-medium text-sm transition-colors hover:bg-zinc-400"
          >
            Subscribe Now
          </motion.button>
        </div>
