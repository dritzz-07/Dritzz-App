    ...
    <div className="px-4 pt-6 pb-24 animate-in fade-in duration-500">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-neutral-900 rounded-3xl p-5 border border-neutral-800 relative overflow-hidden">
          <div className="absolute top-0 right-0 px-3 py-1 bg-blue-600 rounded-bl-xl text-xs font-semibold text-white">UPCOMING</div>
          ...
          <div className="mt-4 flex gap-3">
            ...
            <button className="flex-1 bg-blue-600 text-white font-medium py-3 justify-center items-center rounded-xl text-sm transition-colors hover:bg-blue-500">
              Track Team
            </button>
          </div>
        </div>
        ...
        <div className="bg-neutral-900/50 rounded-3xl p-4 border border-neutral-800/50 flex flex-col opacity-80">
          <div className="flex justify-between items-start mb-2">
            ...
            <span className="text-xs font-medium text-emerald-500 bg-emerald-500/10 px-2 py-1 rounded-md">COMPLETED</span>
          </div>
        </div>
